...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const res = await login(cleanTrigram, password, 'admin');
      ...
      <div className="card fade-in" style={{ maxWidth: '420px', width: '100%', padding: '2.5rem' }}>
        ...
        <form onSubmit={handleLogin}>
          <div className="form-group">
            <label className="form-label">Admin Trigram (3-Lettters)</label>
          ...
          <button type="submit" disabled={isSubmitting} className="btn btn-primary" style={{ width: '100%', height: '48px', marginTop: '1rem' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1rem', fontFamily: 'monospace', color: 'var(--primary)', fontWeight: 800 }}>
            ADM / admin123
          </p>
        </div>
      </div>
